...
public class Spill {
	...
	/**
	 * NÂr fra-bunken blir tom, tar man vare pÂ kortet pÂ toppen av
	 * til-bunken. Deretter legges alle den andre kortene i til-bunken over i
	 * fra-bunken. Denne stokkes og kortet som man har tatt vare pÂ legges
	 * tilbake i til-bunken. Det vil nÂr vÊre det eneste kortet i til-bunken.
	 */
	...
	/**
	 * Metode for Â si forbi. MÂ nullstille antall ganger spilleren har
	 * trukket kort.
	 * 
	 * @param spiller
